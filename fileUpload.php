...
<html>
    <head>
        <title>Mati's Bookclub - Upload</title>
		 <meta charset="utf-8">
               ...
               <div>
                   ...
                   if (isset($error)){
                       if (empty($error)){
                           ...
                           echo '<a href="uploadedfiles/' . $_FILES['upload']['name'] . '">VIew the file';
						   echo '<br><a href="gallery.php">Go to Gallery';
